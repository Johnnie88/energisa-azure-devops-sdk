...
export class WorkItemTrackingRestClient extends RestClientBase {
   ...
   *
   */
  public async getRecentActivityData(): Promise<
    WorkItemTracking.AccountRecentActivityWorkItemModel2[]
  > {
   ...
   *
   */
  public async getRecentMentions(): Promise<
    WorkItemTracking.AccountRecentMentionWorkItemModel[]
  > {
    return this.beginRequest<
      WorkItemTracking.AccountRecentMentionWorkItemModel[]
    >({
   ...
   *
   */
  public async getWorkArtifactLinkTypes(): Promise<
    WorkItemTracking.WorkArtifactLink[]
  > {
   ...
   */
  public async deleteQuery(project: string, query: string): Promise<void> {
    return this.beginRequest<void>({
      apiVersion: "5.0-preview.2",
      method: "DELETE",
      routeTemplate: "{project}/_apis/wit/queries/{*query}",
   ...
   * @param project - Project ID or project name
   */
  public async destroyWorkItem(id: number, project?: string): Promise<void> {
    return this.beginRequest<void>({
      apiVersion: "5.0-preview.2",
      method: "DELETE",
  ...
  public async getRevision(
    ...
    return this.beginRequest<WorkItemTracking.WorkItem>({
      apiVersion: "5.0-preview.3",
      routeTemplate:
        "{project}/_apis/wit/workItems/{id}/revisions/{revisionNumber}",
      routeValues: {
        project: project,
        id: id,
  ...
  public async getUpdate(
    ...
    return this.beginRequest<WorkItemTracking.WorkItemUpdate>({
      apiVersion: "5.0-preview.3",
      routeTemplate:
        "{project}/_apis/wit/workItems/{id}/updates/{updateNumber}",
      routeValues: {
        project: project,
        id: id,
   ...
   *
   */
  public async getWorkItemIcons(): Promise<WorkItemTracking.WorkItemIcon[]> {
    return this.beginRequest<WorkItemTracking.WorkItemIcon[]>({
      apiVersion: "5.0-preview.1",
      routeTemplate: "_apis/wit/workItemIcons/{icon}",
    });
   ...
   *
   */
  public async getRelationTypes(): Promise<
    WorkItemTracking.WorkItemRelationType[]
  > {
    return this.beginRequest<WorkItemTracking.WorkItemRelationType[]>({
      apiVersion: "5.0-preview.2",
      routeTemplate: "_apis/wit/workItemRelationTypes/{relation}",
  ...
  public async getWorkItemTypeColors(
    ...
    return this.beginRequest<
      { key: string; value: WorkItemTracking.WorkItemTypeColor[] }[]
    >({
      apiVersion: "5.0-preview.1",
      method: "POST",
  ...
  public async getWorkItemTypeColorAndIcons(
    ...
    { key: string; value: WorkItemTracking.WorkItemTypeColorAndIcon[] }[]
  > {
    return this.beginRequest<
      { key: string; value: WorkItemTracking.WorkItemTypeColorAndIcon[] }[]
    >({
  ...
  public async getWorkItemTypeFieldsWithReferences(
    ...
    return this.beginRequest<
      WorkItemTracking.WorkItemTypeFieldWithReferences[]
    >({
      apiVersion: "5.0-preview.3",
  ...
  public async updateWorkItemTypeDefinition(
    ...
    /**
     * Returns a single work item type of the specific version.
     *
     * @param project - Project ID or project name
     * @param type - Work item type name
     * @param revision - The work item type revision
     */
  public async getColumnNames(project: string): Promise<string[]> {
    const queryValues: any = {
      project: project,
    };
    ...
    return this.beginRequest<string[]>({
      apiVersion: "5.0-preview.1",
      method: "GET",
      routeTemplate: "{project}/_apis/wit/columnNames",
      queryParams: queryValues,
    });
  }
}
